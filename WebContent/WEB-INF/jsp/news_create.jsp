		        ...
		        <div class="row">
		        	<form class="form-horizontal" action="<%=PathUtil.getFullPath("news/submit-create")%>" method="post" enctype="multipart/form-data">
						<div class="form-group">
							...
							<div class="col-md-8">
								<div class="input-group">							
									<input id="news_title" name="news_title" type="text" class="form-control1" placeholder="news title">
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-3">
							  <select class="form-control1 ng-invalid ng-invalid-required" ng-model="model.select" id="rangeSelect" name="news_age">
						...
						<div class="form-group">
							...
							<div class="col-md-3">
							  <select class="form-control1 ng-invalid ng-invalid-required" ng-model="model.select" id="multiselect" name="news_type">
				                <option></option>
						...
						<div class="form-group">
							...
							<div class="col-md-3">
								<input name="news_image" type="file" id="exampleInputFile">
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-2 control-label">正文:</label>
							<div class="col-md-8">
								<textarea name="news_content" class="form-control" rows="12"></textarea>
							</div>
						</div>
						<div class="row">
